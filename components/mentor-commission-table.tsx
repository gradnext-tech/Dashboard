              ...
              {filteredAndSortedData.map((mentor, index) => {
                ...
                return (
                  <tr key={`${mentor.mentorName}-${mentor.mentorEmail}`} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className={`text-sm font-bold ${displayValues.payout < 0 ? 'text-red-600' : 'text-gray-900'}`}>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className={`text-lg font-bold ${displayValues.payout < 0 ? 'text-red-600' : 'text-gray-900'}`}>
                        {formatCurrency(displayValues.payout)}
                      </p>
                    </div>
                    <div>
